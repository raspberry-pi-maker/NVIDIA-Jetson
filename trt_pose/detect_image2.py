...
if 'resnet50' in args.model:
    ...
    MODEL_WEIGHTS = 'resnet50_baseline_att_368x368_A_epoch_250.pth'
    OPTIMIZED_MODEL = 'resnet50_baseline_att_368x368_A_epoch_250_trt.pth'
...
h,w,c = src.shape
print('image shape W[%d] H[%d] Channel[%d]'%(w,h,c))
