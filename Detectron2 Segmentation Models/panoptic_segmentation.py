...
help = 'Base-Panoptic-FPN'
help += ',panoptic_fpn_R_101_3x'
help += ',panoptic_fpn_R_50_1x'
help += ',panoptic_fpn_R_50_3x'


parser = argparse.ArgumentParser()
parser.add_argument('--model', type=str, default = 'panoptic_fpn_R_50_3x', help = help)
...
network_model = 'COCO-PanopticSegmentation/' + opt.model + '.yaml'
